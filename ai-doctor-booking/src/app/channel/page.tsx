...
export default function ChannelSelectionPage() {
  ...
  return (
    <div className="h-screen max-h-screen overflow-hidden fixed inset-0 flex flex-col py-4 px-4" style={{ backgroundColor: '#E6F0FA' }}>
      ...
      <div className="flex flex-col gap-3 w-full max-w-lg mx-auto flex-1 justify-center">
        ...
        <div className="text-center text-xs text-medium-grey mt-2">
          ...
          <p className="mt-1 flex items-center justify-center">
            ...
            Las citas pueden ser reprogramadas minimo con 4 horas de antelación
          </p>
        </div>
      </div>
    </div>
