    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
        ...
        <div 
          ...
          className="bg-white rounded-xl shadow-lg p-6 transition-transform hover:transform hover:scale-105 cursor-pointer"
        >
          ...
          <h3 className="text-xl font-semibold text-dark-grey mb-2">Phone Call</h3>
          <p className="text-medium-grey">Speak with our virtual assistant to book your appointment</p>
        </div>
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-dark-grey mb-2">WhatsApp</h3>
          <p className="text-medium-grey">Chat with our AI assistant through WhatsApp</p>
        </div>
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-dark-grey mb-2">In-App</h3>
          <p className="text-medium-grey">Book directly through our app interface</p>
        </div>
      </div>
    </div>
  );
