...
export default function BookingDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="pb-24" style={{ backgroundColor: '#F2F2F7' }}>
      {/* Header */}
      <div className="text-white p-6 relative" style={{ backgroundColor: '#6b7f94' }}>
        {/* Close button */}
        <button 
      ...
      {/* Booking information */}
      <div className="p-4" style={{ backgroundColor: '#F2F2F7' }}>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-medium-grey text-xs">Si no puedes asistir, cancela con 2 horas de anticipación.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {isFutureDate(selectedBooking.date) ? (
            ...
            <>
              ...
              <p className="text-medium-grey mb-3">
                Si necesitas cambiar la fecha o hora de tu cita, puedes hacerlo directamente en la app.
              </p>
