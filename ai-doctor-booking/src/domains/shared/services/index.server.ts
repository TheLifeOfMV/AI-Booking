...
import * as PatientService from '@/domains/patientService/services/patientService.server';
import * as DoctorService from '@/domains/doctorService/services/doctorService.server';
