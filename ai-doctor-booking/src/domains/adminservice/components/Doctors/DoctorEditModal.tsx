...
import { Doctor, CredentialStatus } from '@/domains/doctorService/types/doctor';
import { updateDoctor } from '@/domains/doctorService/services/doctorService';
import { useToast } from '@/domains/shared/components/ToastProvider';
